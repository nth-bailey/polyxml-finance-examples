...
SCHEMA_PATH="schemas/finance/pacs_008_core.xsd"

echo "================================================================================"
echo "🏦 PolyXML Code Generation Showcase (All 7 Target Languages)"
echo "   Schema: ${SCHEMA_PATH} (ISO 20022 Financial Customer Credit Transfer)"
echo "================================================================================"
